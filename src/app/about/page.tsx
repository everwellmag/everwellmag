  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="prose max-w-3xl mx-auto">
        <p>
          Everwell Magazine is your trusted source for health and wellness
          insights. We provide evidence-based articles and product reviews to
          help you live a healthier life. Our mission is to empower you with
