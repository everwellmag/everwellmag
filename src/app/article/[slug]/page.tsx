...
const getArticleData = async (slug: string) => {
    try {
        ...
        console.log('Article data for page:', JSON.stringify(data, null, 2));
    ...
    return (
        <main style={{ backgroundColor: 'var(--background)', color: 'var(--foreground)' }} className="max-w-5xl mx-auto p-6">
            ...
            <div className="mt-6 flex gap-4 flex-wrap justify-center">
                <a
                    href={`https://x.com/intent/tweet?url=https://www.everwellmag.com/article/${article.slug}&text=Check out "${title || 'this article'}" on Everwell Magazine!`}
                    target="_blank"
                ...
                <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=https://www.everwellmag.com/article/${article.slug}`}
                    target="_blank"
                    rel="noopener noreferrer nofollow"
                    className="flex items-center gap-2 px-4 py-2 bg-[var(--background)] text-[var(--foreground)] rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition-transform duration-200 border border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800"
                >
                ...
                <a
                    href={`https://www.instagram.com/?url=https://www.everwellmag.com/article/${article.slug}`}
                    target="_blank"
                    rel="noopener noreferrer nofollow"
                    className="flex items-center gap-2 px-4 py-2 bg-[var(--background)] text-[var(--foreground)] rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition-transform duration-200 border border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800"
                >
