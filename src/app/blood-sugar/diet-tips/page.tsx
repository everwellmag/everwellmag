...
export default function DietTipsForBloodSugarPage() {
        ...
        const fetchArticles = async () => {
            try {
                const response = await fetch(
                    'https://cms.everwellmag.com/api/articles?filters[category][id]=7&pagination[page]=1&pagination[pageSize]=10&populate=*',
                    {
                        headers: {
    ...
    return (
        <div className="container mx-auto p-4" style={{ backgroundColor: 'var(--background)', color: 'var(--foreground)' }}>
            <h1 className="text-3xl font-bold mb-6" style={{ color: 'var(--foreground)' }}>Diet Tips for Blood Sugar</h1>
            <p className="mb-8" style={{ color: 'var(--foreground)' }}>
                Explore diet tips designed to help manage blood sugar levels with expert
                advice and healthy eating strategies.
            </p>
