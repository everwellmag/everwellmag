...
export default function CommonHeartConditionsPage() {
        ...
        const fetchArticles = async () => {
            try {
                ...
                const response = await fetch(
                    `https://cms.everwellmag.com/api/articles?filters[category][id]=15&pagination[page]=${currentPage}&pagination[pageSize]=10&populate=*`,
                    {
                        headers: {
                ...
                if (!data.data || data.data.length === 0) {
                    throw new Error('No articles found for category ID 15');
                }
    ...
    return (
        <div className="container mx-auto p-6" style={{ backgroundColor: 'var(--background)', color: 'var(--foreground)' }}>
            ...
            <div className="relative text-white rounded-lg p-8 mb-12" style={{ background: 'var(--gradient-primary)' }}>
                <h1 className="text-4xl font-bold mb-4">Common Heart Conditions</h1>
                <p className="text-lg max-w-2xl">
                    Learn about common heart conditions, their symptoms, and management strategies with expert insights.
                </p>
            </div>
            ...
            {pageCount > 1 && (
                <div className="flex justify-center items-center mt-8 space-x-4">
                    <button
                        ...
                        className={`px-4 py-2 rounded-md ${currentPage === 1 ? 'bg-gray-300 cursor-not-allowed' : 'btn-gradient text-white'}`}
                    >
                        Previous
                    </button>
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-md ${currentPage === pageCount ? 'bg-gray-300 cursor-not-allowed' : 'btn-gradient text-white'}`}
                    >
                        Next
                    </button>
                </div>
