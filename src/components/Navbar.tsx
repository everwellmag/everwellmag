...
export default function Navbar() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      label: "Eye Health",
      subItems: [
        { href: "/eye-care-tips", label: "Eye Care Tips" },
        { href: "/common-eye-conditions", label: "Common Eye Issues" },
        { href: "/supplements-for-eye-health", label: "Supplements for Eye" },
      ],
    },
    {
      href: "/heart-health",
      label: "Heart Health",
      subItems: [
        { href: "/common-heart-conditions", label: "Common Heart Conditions" },
        { href: "/heart-care-tips", label: "Heart Care Tips" },
        { href: "/supplements-for-heart-health", label: "Supplements for Heart Health" },
      ],
    },
    {
      href: "/mens-health",
      label: "Men's Health",
      subItems: [
        { href: "/common-mens-health-issues", label: "Common Men’s Health Issues" },
        { href: "/mens-care-tips", label: "Men’s Care Tips" },
        { href: "/supplements-for-mens-health", label: "Supplements for Men’s Health" },
      ],
    },
    {
      href: "/womens-health",
      ...
      subItems: [
        { href: "/common-womens-health-issues", label: "Common Women’s Health Issues" },
        { href: "/womens-care-tips", label: "Women’s Care Tips" },
